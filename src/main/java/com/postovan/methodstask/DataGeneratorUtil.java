package com.postovan.methodstask;
...
public class DataGeneratorUtil {
    ...
    public static int getRandomInt (int min, int max) {
        if (min >= max) {
            System.out.println("Valoarea minima treuie sa fie mai mica ca cea maxima");
            return 0;
        }
        int delta = max - min;
    ...
    public static String generateValidRandomString (int length) {
        String acceptedChars = "ABCDEFGHIJKLMNOPRSTQUVWabmcvndsidusnfalkm0123456789";
        ...
        for (int i = 0; i < length; i++) {
            ...
            System.out.println("In iteratia: i = " + i + "caracterul alipit " + acceptedChars.charAt(randomIndex));
        }
